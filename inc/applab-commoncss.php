...
// enqueue css
function applab_common_custom_css(){
    
    wp_enqueue_style( 'applab-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= applab_opt( 'applab_theme_color' ) != '#131313' ? applab_opt( 'applab_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= applab_opt( 'applab_book_btn_color' ) != '#131313' ? applab_opt('applab_book_btn_color') : '';
		$bookBtnHoverBgColor     	= applab_opt( 'applab_book_btn_hvr_bg_color' ) != '#131313' ? applab_opt('applab_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = applab_opt( 'applab_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = applab_opt( 'applab_navbar_bg_color' ) != '#082b49' ? applab_opt( 'applab_navbar_bg_color') : '';
		$headerTop_col     		  = applab_opt( 'applab_top_header_color' );

		$headerTopBg      		  = applab_opt( 'applab_top_header_bg_color');
		$headerBg          		  = applab_opt( 'applab_header_bg_color') != '#ffffff' ? applab_opt( 'applab_header_bg_color') : '';
		$menuColor          	  = applab_opt( 'applab_header_menu_color' ) != '#131313' ? applab_opt('applab_header_menu_color') : '';
		$menuHoverColor           = applab_opt( 'applab_header_menu_hover_color' ) != '#808080' ? applab_opt('applab_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = applab_opt( 'applab_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = applab_opt( 'applab_header_drop_menu_bg_color' ) != '#ffffff' ? applab_opt('applab_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = applab_opt( 'applab_dropdown_menu_color' ) != '#131313' ? applab_opt('applab_dropdown_menu_color') : '';
		$dropMenuHovColor         = applab_opt( 'applab_dropdown_menu_hover_color' ) != '#808080' ? applab_opt('applab_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = applab_opt( 'applab_footer_widget_bg_color' );
		$footerwHeadColor   	  = applab_opt('applab_footer_widget_heading_color');
		$footerwTextColor   	  = applab_opt('applab_footer_widget_text_color');
		$footerwanchorcolor 	  = applab_opt('applab_footer_widget_anchor_color') != '#ffffff' ? applab_opt('applab_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = applab_opt('applab_footer_widget_anchor_hover_color') != '#ffffff' ? applab_opt('applab_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = applab_opt('applab_fof_bg_color');
		$foftonecolor			  = applab_opt('applab_fof_textone_color');
		$fofttwocolor			  = applab_opt('applab_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = applab_opt('applab_footer_widget_anchor_color') != '#9e9e9e' ? applab_opt('applab_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .applab_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .applab_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'applab-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'applab_common_custom_css', 50 );