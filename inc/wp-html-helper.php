...
// image default alt
if ( ! function_exists( 'applab_img_default_alt' ) ) {
	function applab_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'applab_img_tag' ) ) {
	function applab_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = applab_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'applab_anchor_tag' ) ) {
	function applab_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'applab_heading_tag' ) ) {
	function applab_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'applab_paragraph_tag' ) ) {
	function applab_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'applab_other_tag' ) ) {
	function applab_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'applab_button_element ' ) ) {
	function applab_button_element( array $args ) {
